      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs">
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors font-mono text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-xs text-emerald-700">
            ...
            <ul className="space-y-1 mt-1">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600"/> Maksimal 4 anggota per tim</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600"/> Kapten bisa mengundang dengan kode tim</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600"/> Battle tim dilakukan 4v4</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-600"/> Semua anggota harus dari PT yang sama</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-xl border border-slate-100 text-center">
            ...
            <p className="text-sm text-slate-500 mb-4">
              ...
              <span className="font-bold text-emerald-700">{modal.teamName}</span>.
            </p>
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 mb-5">
              ...
              <p className="font-mono text-3xl font-black text-emerald-700 tracking-widest">
                {modal.teamCode}
              </p>
            </div>
            <button
              onClick={() => router.push(`/murid/battle/team/${modal.teamId}`)}
